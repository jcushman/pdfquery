...
class TestPDFQuery(BaseTestCase):
    ...
    def test_selectors(self):
        ...
        """
        label = self.pdf.pq(
            'LTTextLineHorizontal:contains("Your first name ' 'and initial")'
        )
    ...
    def test_extract(self):
        ...
        values = self.pdf.extract(
            [
                ...
                (
                    "oath",
                    'LTTextLineHorizontal:contains("perjury")',
                    lambda match: match.text()[:30] + "...",
                ),
                (
                    "year",
                    'LTTextLineHorizontal:contains("Form 1040A (")',
        ...
        doc_info_results = [
            [
                "tests/samples/bug11.pdf",
                {
                    ...
                    "Title": "\u262d\U0001f61c\U0001f4a9Unicode is fun!",
                    "Author": "Russkel",
                    "Creator": "Firefox",
                    "ModDate": "D:20140528141914+08'00'",
                    "CreationDate": "D:20140528061106Z",
                    "Subject": "",
                },
            ],
            [
...
class TestUnicode(BaseTestCase):
    def test_unicode_text(self):
        ...
        self.assertEqual(
            ...
            (
                "5 Hop Hing Oils and Fats (Hong Kong) Ltd \uf06c "
                "\u7279\u5bf6\u7cbe\u88fd\u8c6c\u6cb9"
            ),
        )
    ...
    def test_invalid_xml_characters(self):
        ...
        pdf.load(
            2
        )  # throws error if we fail to strip ascii control characters -- see issue #39
...
class TestPageRange(BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.pdf = pdfquery.PDFQuery(
            "tests/samples/bug67.pdf", parse_tree_cacher=FileCache(cache_dir)
        )
